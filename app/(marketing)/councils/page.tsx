        ...
        <div className="cols-2" style={{ maxWidth: 'var(--container)', margin: '0 auto', padding: 'var(--sp-16) var(--sp-6)', gap: 'var(--sp-16)', alignItems: 'start' }}>
          <div>
            ...
            <p className="t-body-lg" style={{ color: 'var(--steel-100)', marginBottom: 'var(--sp-5)' }}>
              Stredar is a covert speed monitoring device — a community data tool, not an enforcement camera.
            ...
            <p className="t-body" style={{ color: 'var(--steel-200)' }}>
              ...
              speed statistics — the same category of data generated by existing council-approved speed monitoring deployments.
            </p>
          </div>
        ...
        <div style={{ maxWidth: 'var(--container)', margin: '0 auto', padding: 'var(--sp-16) var(--sp-6)' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(240px, 1fr))', gap: 0 }}>
            {[
              ...
              { n: '04', heading: 'Monitor behaviour change', body: 'Continuous speed logging across weeks and months builds a robust trend dataset, showing whether behaviour at a location is stable, worsening, or improving over time.' },
            ].map((item, i) => (
